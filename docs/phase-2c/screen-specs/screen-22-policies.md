# Policies — High-Fidelity Screen Specification

## Visual hierarchy

Lead with Title/effective date; sequence Contents rail → Readable policy body → Related policies → Support. One dominant action and restrained evidence-led supporting actions.
