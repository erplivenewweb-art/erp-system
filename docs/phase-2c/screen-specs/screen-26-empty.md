# Empty — High-Fidelity Screen Specification

## Visual hierarchy

Lead with Contextual illustration; sequence Reason → Primary recovery → Secondary discovery. One dominant action and restrained evidence-led supporting actions.
