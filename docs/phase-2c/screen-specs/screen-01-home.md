# Home — High-Fidelity Screen Specification

## Visual hierarchy

Lead with Editorial hero; sequence Trust proof → Collections → Featured products → Manufacturing story → Workshop/artisans → Purity/packaging → Reviews → Wholesale/custom → Journal/FAQ → Footer. One dominant action and restrained evidence-led supporting actions.
