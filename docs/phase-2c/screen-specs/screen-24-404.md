# 404 — High-Fidelity Screen Specification

## Visual hierarchy

Lead with Quiet error mark; sequence Explanation → Search → Curated destinations → Support. One dominant action and restrained evidence-led supporting actions.
