# Error — High-Fidelity Screen Specification

## Visual hierarchy

Lead with Safe error heading; sequence Preserved context → Recovery action → Correlation reference → Support. One dominant action and restrained evidence-led supporting actions.
