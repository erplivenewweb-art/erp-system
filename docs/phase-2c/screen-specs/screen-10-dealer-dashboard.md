# Dealer Dashboard — High-Fidelity Screen Specification

## Visual hierarchy

Lead with Dealer status; sequence Operational metrics → Expiring quotations → Orders/dispatch → Bulk actions → Support. One dominant action and restrained evidence-led supporting actions.
