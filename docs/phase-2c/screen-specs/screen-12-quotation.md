# Quotation — High-Fidelity Screen Specification

## Visual hierarchy

Lead with Status/revision; sequence Change comparison → Line snapshots → Terms/messages → Accept/revise/reject → History. One dominant action and restrained evidence-led supporting actions.
