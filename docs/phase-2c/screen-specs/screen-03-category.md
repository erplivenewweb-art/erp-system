# Category — High-Fidelity Screen Specification

## Visual hierarchy

Lead with Breadcrumb; sequence Category title/count → Filter/sort → Product grid → FAQ → Related taxonomy. One dominant action and restrained evidence-led supporting actions.
