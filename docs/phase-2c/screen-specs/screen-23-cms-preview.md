# CMS Preview — High-Fidelity Screen Specification

## Visual hierarchy

Lead with CMS chrome; sequence Device/locale/audience controls → Rendered preview → SEO/a11y/performance checks → Version diff → Publish action. One dominant action and restrained evidence-led supporting actions.
...
- CMS chrome
- Device + locale + audience controls
- Rendered preview
- SEO + a11y + performance checks
- Version diff
- Publish action
- Header/navigation
...
- Control labels are system-owned; previewed structured content retains its original CMS ownership
