# Dealer Catalogue — High-Fidelity Screen Specification

## Visual hierarchy

Lead with Bulk search; sequence Filter rail → Dense list/grid → Authorized price/MOQ/slabs → Bulk cart tray. One dominant action and restrained evidence-led supporting actions.
