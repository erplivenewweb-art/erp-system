# Support — High-Fidelity Screen Specification

## Visual hierarchy

Lead with Help search; sequence Topic cards → Order help → Contact channels → Hours/status. One dominant action and restrained evidence-led supporting actions.
