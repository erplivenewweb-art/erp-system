# Contact — High-Fidelity Screen Specification

## Visual hierarchy

Lead with Reason selector; sequence Accessible form → Approved WhatsApp/contact → Hours → Privacy. One dominant action and restrained evidence-led supporting actions.
