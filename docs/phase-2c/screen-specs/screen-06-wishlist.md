# Wishlist — High-Fidelity Screen Specification

## Visual hierarchy

Lead with Title/count; sequence Saved product grid → Price/availability refresh → Move-to-cart controls → Recommendations. One dominant action and restrained evidence-led supporting actions.
