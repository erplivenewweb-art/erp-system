# Search — High-Fidelity Screen Specification

## Visual hierarchy

Lead with Search field/suggestions; sequence Result summary → Filter/sort → Product results → No-results recovery. One dominant action and restrained evidence-led supporting actions.
