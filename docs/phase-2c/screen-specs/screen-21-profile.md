# Profile — High-Fidelity Screen Specification

## Visual hierarchy

Lead with Identity summary; sequence Editable contact → Preferences/consent → Security → Account closure. One dominant action and restrained evidence-led supporting actions.
