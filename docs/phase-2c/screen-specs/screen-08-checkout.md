# Checkout — High-Fidelity Screen Specification

## Visual hierarchy

Lead with Progress; sequence Contact/address → Delivery → Future payment → Review/consent → Sticky order summary. One dominant action and restrained evidence-led supporting actions.
