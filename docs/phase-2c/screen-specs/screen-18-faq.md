# FAQ — High-Fidelity Screen Specification

## Visual hierarchy

Lead with Search; sequence Topic navigation → Accessible accordions → Support escalation. One dominant action and restrained evidence-led supporting actions.
