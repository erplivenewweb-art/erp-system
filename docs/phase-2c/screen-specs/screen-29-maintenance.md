# Maintenance — High-Fidelity Screen Specification

## Visual hierarchy

Lead with Brand mark; sequence Service notice → Affected scope → Status/time → Alternative support. One dominant action and restrained evidence-led supporting actions.
