# Dealer Registration — High-Fidelity Screen Specification

## Visual hierarchy

Lead with Value/eligibility; sequence Progress stepper → Business/GST/evidence fields → Save/resume → Review/support. One dominant action and restrained evidence-led supporting actions.
