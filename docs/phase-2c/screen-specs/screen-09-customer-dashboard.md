# Customer Dashboard — High-Fidelity Screen Specification

## Visual hierarchy

Lead with Greeting; sequence Active order → Quick links → Orders → Wishlist → Notifications/support. One dominant action and restrained evidence-led supporting actions.
