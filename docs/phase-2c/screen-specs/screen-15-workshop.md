# Workshop — High-Fidelity Screen Specification

## Visual hierarchy

Lead with Place portrait; sequence Photo essay → Tools/materials → People with consent → Process boundaries → Visit products. One dominant action and restrained evidence-led supporting actions.
