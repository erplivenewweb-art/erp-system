# Success — High-Fidelity Screen Specification

## Visual hierarchy

Lead with Restrained confirmation; sequence Safe reference → Summary → Next steps → Support. One dominant action and restrained evidence-led supporting actions.
