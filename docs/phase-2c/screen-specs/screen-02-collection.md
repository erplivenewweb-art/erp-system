# Collection — High-Fidelity Screen Specification

## Visual hierarchy

Lead with Breadcrumb; sequence Editorial collection hero → Story → Filter/sort → Product grid → Craft note → Related collections. One dominant action and restrained evidence-led supporting actions.
