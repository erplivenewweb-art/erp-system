# Manufacturing Story — High-Fidelity Screen Specification

## Visual hierarchy

Lead with Film hero; sequence Process overview → Workshop → Tools → Artisans → Quality/purity → Product bridge. One dominant action and restrained evidence-led supporting actions.
