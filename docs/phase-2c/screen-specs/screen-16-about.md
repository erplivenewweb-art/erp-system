# About — High-Fidelity Screen Specification

## Visual hierarchy

Lead with Brand thesis; sequence Values → Manufacturer evidence → Milestones → People → Trust/CTA. One dominant action and restrained evidence-led supporting actions.
