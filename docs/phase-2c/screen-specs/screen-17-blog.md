# Blog — High-Fidelity Screen Specification

## Visual hierarchy

Lead with Editorial hero; sequence Topics → Featured guide → Article grid → Newsletter. One dominant action and restrained evidence-led supporting actions.
