# Product — High-Fidelity Screen Specification

## Visual hierarchy

Lead with Breadcrumb; sequence Gallery/video/360 → Title/reviews → Facts → Price/availability → Variants/quantity → Primary action → Delivery/returns → Craft/packaging/care → FAQ/related. One dominant action and restrained evidence-led supporting actions.
