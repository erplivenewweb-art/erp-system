# Cart — High-Fidelity Screen Specification

## Visual hierarchy

Lead with Items/quantity; sequence Freshness validation → Trust notes → Order estimate → Primary checkout action. One dominant action and restrained evidence-led supporting actions.
